...
<div class="jumbotron d-flex p-5 mb-4 bg-light rounded-3 ">
    <div class="profile_account d-flex align-items-center align-content-center ">
        <img width="200" class="img-fluid rounded-square" src="/img/fotografo.jpg" alt="...">
    </div>
    <div class="container py-5 d-flex">
        
        <div class="description_profile">
            <h1 class="display-5 fw-bold">Pinco Pallino - Catturare Momenti, Raccontare Storie</h1>
            <p>
